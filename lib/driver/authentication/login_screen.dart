...
import '/driver/authentication/car_info_screen.dart';
import '/driver/authentication/signup_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  loginDriverNow() async {
    ...
    if (firebaseUser != null) {
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (c) => const DriverSplashScreen()));
    } else {
      Navigator.pop(context);
          ...
          child: Column(
            children: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (c) => UserSplashScreen()));
                },
                child: Text(
